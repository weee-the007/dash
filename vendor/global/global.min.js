...
function dlabSettings({typography, version, layout, navheaderBg, headerBg, sidebarStyle, sidebarBg, sidebarPosition, headerPosition,themecolor,themeBg, containerLayout, direction, primary,navigationBarImg}) {
...
dlabSettings.prototype.manageThemecolor = function() {
	switch(this.themecolor) {
        case "theme_1": 
            body.attr("data-theme", "theme_1");
			 break;
        case "theme_2": 
            body.attr("data-theme", "theme_2");
            break;
		case "theme_3": 
            body.attr("data-theme", "theme_3");
            break;
		case "theme_4": 
            body.attr("data-theme", "theme_4");
            break;
		case "theme_5": 
            body.attr("data-theme", "theme_5");
            break;
		case "theme_6": 
            body.attr("data-theme", "theme_6");
            break;	
		case "theme_7": 
            body.attr("data-theme", "theme_7");
            break;
        default:
            body.attr("data-theme", "theme_1");
    }
...
dlabSettings.prototype.manageThemeBg = function() {
    switch(this.themeBg) {
        case "theme_1": 
            body.attr("data-theme", "theme_1");
            break;
...
dlabSettings.prototype.manageNavigationBarImg = function() {
	
	if(this.navigationBarImg)
	{
			sidebarBgImg = this.navigationBarImg;
